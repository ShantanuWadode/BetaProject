...
const [toggle,setToggle] = useState(false);
    ...
    <div className='flex justify-between '>
      ...
      <div className='hidden md:flex'>
        <ul className='flex flex-row'>
          ...
          <li className='mr-4 transition-all ease-in-out hover:scale-110 cursor-pointer'><a href="/test">About</a></li>
 ...
 {toggle?
  <ul className='flex flex-col mt-8 bg-white-300 p-2 '>
          ...
          <li className='p-3 mr-4 transition-all ease-in-out hover:scale-110 cursor-pointer'>About</li>
